...
namespace P06_Sneaking
{
    ...
    {
        public static void SearchForEnemiesOnSamRow(char[][] room, int[] samPosition, int[] getEnemy)
        {
        ...
        public void PositionSam(int[][] room, int[] samPosition)
        {
        ...
        public static void MoveSam(char[][] room, char[] moves, int[] samPosition, int i)
        {
        ...
        public static int MoveEnemy(char[][] room, int row, int col)
        {
            if (room[row][col] == 'b')
            {
        ...
        public static void KillNikoladze(char[][] room, int[] samPosition, int[] getEnemy)
        {
        ...
        public static void KillSamIfWithinReach(char[][] room, int[] samPosition, int[] getEnemy)
        {
