namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        {
            var postDetailsontroller = (PostDetailsController)this.CurrentController;
            var addReplyController = (AddReplyController) this.controllers[(int)MenuState.AddReply];
            addReplyController.SetPostId(postDetailsontroller.PostId);
        ...
        private void LogInUser()
        {
            ...
            {
                if (controller is IUserRestrictedController userRestrictedControler)
                {
                    userRestrictedControler.UserLogIn();
                }
            }
        }
        ...
        private void LogOutUser()
        {
            foreach (var controller in controllers)
            {
                if (controller is IUserRestrictedController userRestrictedControler)
                {
                    userRestrictedControler.UserLogOut();
                }
            }
        }
